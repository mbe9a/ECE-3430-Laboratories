...
void InitTRXVariables(void){
        ...
        Xmit1.Transmit_Data_Buffer = 0x00010001 ;  //31 data bits and 1 don't care bit
        Xmit1.Transmit_Data = 0x00010001        ; //31 data bits and 1 don't care bit
        Xmit1.Transmit_Clock_Phase = FullBit ;
        Xmit1.Transmitter_State = StartBit ;
        Xmit1.InterwordTimeout = 0;
        Xmit1.Ones = 0;
    #endif
    #ifdef RX_ENABLED
        //etc. .....
